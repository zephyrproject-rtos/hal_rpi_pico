...
#define PLL_SYS_VCO_FREQ_HZ                (PLL_SYS_VCO_FREQ_KHZ * PICO_KHZ)
#endif
#endif

#if (SYS_CLK_HZ == 125 * PICO_MHZ || SYS_CLK_HZ == 150 * PICO_MHZ) && (XOSC_HZ == 12 * PICO_MHZ) && (PLL_SYS_REFDIV == 1)
// PLL settings for standard 125/150 MHz system clock.
// PICO_CONFIG: PLL_SYS_VCO_FREQ_HZ, System clock PLL frequency, type=int, default=(1500 * PICO_MHZ), advanced=true, group=hardware_clocks
#ifndef PLL_SYS_VCO_FREQ_HZ
...
#define PLL_USB_VCO_FREQ_HZ                 (PLL_USB_VCO_FREQ_KHZ * PICO_KHZ)
#endif
#endif

#if (USB_CLK_HZ == 48 * PICO_MHZ) && (XOSC_HZ == 12 * PICO_MHZ) && (PLL_USB_REFDIV == 1)
// PLL settings for a USB clock of 48MHz.
// PICO_CONFIG: PLL_USB_VCO_FREQ_HZ, USB clock PLL frequency, type=int, default=(1200 * PICO_MHZ), advanced=true, group=hardware_clocks
#ifndef PLL_USB_VCO_FREQ_HZ
#define PLL_USB_VCO_FREQ_HZ                 (1200 * PICO_MHZ)
#endif
